...
from odoo.addons.sale_purchase_inter_company.tests.test_inter_company_sale_purchase import (
    TestSalePurchaseInterCompanyBase,
)


class TestSalePurchaseStockInterCompanyBase(TestSalePurchaseInterCompanyBase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
...
class TestSalePurchaseStockInterCompany(TestSalePurchaseStockInterCompanyBase):
