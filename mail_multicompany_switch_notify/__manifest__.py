# License AGPL-3.0 or later (https://www.gnu.org/licenses/agpl.html).
{
    ...
    "assets": {
        "web.assets_backend": [
            "mail_multicompany_switch_notify/static/src/js/switch_company_mail_check.esm.js",
            "mail_multicompany_switch_notify/static/src/js/mail_server_company_check.esm.js",
