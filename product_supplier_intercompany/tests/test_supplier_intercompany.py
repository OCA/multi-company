...
class TestPricelist(TransactionCase):
    def setUp(self):
        ...
        self.not_intercompany_pricelist = ref("product.list0")
    ...
    def _add_item(self, record, price_surcharge, pricelist_id=None):
        ...
        if record._name == "product.product":
            ...
            vals.update(
                {"applied_on": "1_product", "product_tmpl_id": record.id}
            )
    ...
    def test_add_template_item(self):
        ...
        self._add_item(template, 40)
        self._check_supplier_info_for(template, 490)
    ...
    def test_add_product_item_no_intercompany(self):
        ...
        self._add_item(
            product, 30, pricelist_id=self.not_intercompany_pricelist.id
        )
        self.assertEqual(
            nbr_supplier,
