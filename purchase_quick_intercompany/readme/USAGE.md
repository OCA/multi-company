- First, understand purchase_quick and purchase_sale_inter_company
  modules
- Make an intercompany purchase
- Use arbitrary UoMs, optionally by specifying and intercompany UoM as
  default on product.template
