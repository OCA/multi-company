    ...
    def get_product_intercompany_accounts(self):
        return {
            "income": (
                ...
                or self.categ_id.property_account_income_categ_intercompany
            ),
            "expense": (
                self.property_account_expense_intercompany
                or self.categ_id.property_account_expense_categ_intercompany
            ),
        }
