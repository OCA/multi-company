...
class AccountMove(models.Model):
    ...
    def prepare_other_company_move_line_values(
        ...
        return {
            ...
            "account_id": account
            and account.id
            or line.transfer_to_company_id.due_to_account_id.id,
            "partner_id": partner and partner.id or line.company_id.partner_id.id,
            "debit": debit,
            "credit": credit,
        }
                ...
                if line.transfer_to_company_id:
                    ...
                    if line.transfer_to_company_id.id not in dedicated_companies_vals:
                        ...
                        dedicated_companies_vals[line.transfer_to_company_id.id][
                            ...
                            (0, 0, self.prepare_other_company_move_line_values(line))
                        )
                        account = (
                            account_obj.sudo()
                            .with_company(company_id)
            ...
            if self.env.company.due_fromto_payment_journal_id and transfer_lines:
                ...
                for company_id in dedicated_companies_vals:
                    ...
                    dedicated_company_move += (
                        ...
                        .sudo()
                        .with_company(company_id)
                        .create(dedicated_companies_vals[company_id])
                    )
