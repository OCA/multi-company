...
class TestConsolidatedInvoice(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.invoice_obj_a.date_invoice = date.today() + relativedelta(months=-3)
        ...
        cls.invoice_obj_b.date_invoice = date.today() + relativedelta(months=-3)
    ...
    def test_consolidated_invoice(self):
        ...
        self.assertEqual(
            (self.invoice_obj_a.residual + self.invoice_obj_b.residual),
            inv.amount_total,
        )
