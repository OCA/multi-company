...
class ProductCategory(models.Model):
    ...
    def _multicompany_field_permissions(self):
        ...
        return {
            ...
            "property_price_difference_account_id": "account.group_account_readonly",
            "property_valuation": "account.group_account_readonly,stock.group_stock_manager",  # noqa E501
            "property_cost_method": "account.group_account_readonly,stock.group_stock_manager",  # noqa E501
